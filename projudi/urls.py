...
urlpatterns = [
    ...
    path('oficios/<int:pk>/baixar/', oficio_views.OficioBaixarView.as_view(), name='oficio_baixar'),
    path('oficios/baixar-recebidos/', oficio_views.OficioBulkBaixarView.as_view(), name='oficio_bulk_baixar'),
